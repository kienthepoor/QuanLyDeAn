...
---cau8
CREATE FUNCTION fn_ds_nhanvien_nhap_hang(@ngayNhap DATE)
RETURNS TABLE
AS
RETURN
(
    SELECT DISTINCT Nhanvien.manv, Nhanvien.tennv, Nhanvien.diachi, Nhanvien.sodt, Nhanvien.email, Nhanvien.phong
    FROM Nhanvien
    JOIN Nhap ON Nhanvien.manv = Nhap.manv
    WHERE Nhap.ngaynhap = @ngayNhap
)

SELECT * FROM fn_ds_nhanvien_nhap_hang('2019-02-05')
