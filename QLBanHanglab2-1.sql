...
5. select sohdn, masp, tensp, tenhang, soluongnhap, dongianhap, soluongnhap*dongianhap as tiennhap, mausac, donvitinh, mota, ngay nhap, tennv, phong from Sanpham, Nhanvien, Nhap ORDER BY sohdn ASC


6. select sohdx, masp, tensp, tenhang, soluongxuat, giaban, soluongnhap*giaban as tienxuat, mausac, donvitinh, mota, ngayNhap, tennv, phong from Sanpham, Nhanvien, Xuat WHERE ngaynhap='10-2018' ORDER BY sohdx ASC


7. select sohdn, masp, tensp, soluongnhap, dongianhap, ngaynhap, Manv, tennv, Phong from Nhanvien, Sanpham, Nhap WHERE ngaynhap='2017'


8. select top 10 sohdx, masp, manv, ngayxuat, soluongxuat from Xuat WHERE ngayxuat='10-2018' ORDER BY soluongxuat DESC
...
13. select sohdn, ngaynhap, SUM(dongianhap) as tongtiennhap,  MAX(tongtiennhap) from Nhap WHERE ngaynhap='2018'
